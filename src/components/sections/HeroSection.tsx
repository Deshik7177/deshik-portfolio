        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-20 animate-fadeIn">
          <div className="flex-shrink-0">
            <Image
              ...
              width={200}
              height={200}
              className="rounded-full border-4 border-primary shadow-2xl animate-pulse-neon hover:scale-110 hover:-rotate-y-[8deg] transition-transform duration-500 ease-in-out"
